...
class AnalyzerHelper:
    ...
    def get_test_details(self, search_str):
        ...
        if self.metadata_cache != {} and ENABLE_CACHING: output_dict = self.metadata_cache
            ...
            output_dict = db_connector.fetch_data(table="bkc_regression_test", columns=[
                                                  "id", "test_case", "computer_name", "driver", "asic_id", "vbios_uuid", "test_log", "uuid", "current_cycles", "target_cycles", "start_time", "current_time", "status","local_time"])
    ...
    def get_vbios_metadata(self, search_str):
        ...
        output_dict = db_connector.fetch_data(table="bkc_regression_ifwibuilder", columns=[
        ...
        config_info = {}
        for row in output_dict:
            if output_dict[row]['bios_build_num'] == test_details['vbios_uuid']:
    ...
    def get_config_metadata(self, search_str):
        ...
        # Also append system config data
        output_dict = db_connector.fetch_data(table="bkc_regression_configuration", columns=[
    ...
    def get_test_metadata(self, search_str):
        ...
        output_dict = db_connector.fetch_data(
            table="bkc_regression_json", columns=["id", "json_data", "uuid"])
